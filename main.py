...
print("Welcome to the Musical Time Machine, this creates a playlist from the Billboard Top 100 Playlist from a given date!")

time_travel = input("What year would you like to travel to? Type this as YYYY-MM-DD:\n")
...
song_list = [song.getText().replace('\n','').replace('\t','') for song in song_names_spans]
...
#Create the playlist
playlist = sp.user_playlist_create(user=user_id, name=f"Billboard Top 100 from {time_travel}",public=True, collaborative=False)
